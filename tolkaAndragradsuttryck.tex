...
\subsection{Positiva och negativa andragradsfunktioner}
...
\begin{itemize}
  ...
  \item En andragradsfunktion $f(x)=a(x+d)^2+e$ har \textbf{extremvärdet $e$}.
  \item En andragradsfunktion $f(x)=a(x+d)^2+e$ har \textbf{extrempunkten $(-d, e)$}.
