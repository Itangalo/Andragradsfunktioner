...
\smallskip
\begin{tabular}{m{6.5cm}|p{4.5cm}|b{1.5cm}}
  ...
  \end{tabular} & När vi jämför $x^2$-termerna ser vi att $a$ måste vara 2 för att uttrycken ska vara lika. & $a=2$ \\

  $\Rightarrow$
  \begin{tabular}{ l l l l }
    & $2x^2$ & $\framebox{+28}x$ & $+5$ \\
    $=$ & $2x^2$ & \framebox{$+2\cdot 2 \cdot d$}$x$ & $+2 \cdot d^2+e$ \\
  \end{tabular} & När vi jämför $x$-termerna får vi ekvationen $4d=28$, vilket ger $d = 7$. & $d=7$ \\
